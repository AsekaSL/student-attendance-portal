    ...
    <aside className="hidden md:block w-64 bg-white/80 backdrop-blur-md p-4 h-screen sticky top-0 shadow-lg border-r border-gray-200">
      ...
      <nav className="flex flex-col gap-2 mt-6">
          <div>
            ...
            <Link to="/qrcode" className="sidebar-item flex items-center gap-3 p-3 rounded-lg hover:bg-indigo-50 transition-colors duration-200 hover:shadow-sm text-gray-700 hover:text-indigo-700">
              <span className="sidebar-icon transition-transform duration-200">
                <i data-feather="qrcode" className="w-5 h-5"></i>
              </span>
              <span className="font-medium">QR Code Genarate</span>
            </Link>
